...
四级指数编号 - ZS232
四级指数 - 服务效能指数
指数说明 - 服务类相关事件的处置率与处理周期情况
计算方式 - 各类服务相关事件在一定周期内处理完成的数量(24小时）/服务相关事件总数量
评价方式 - 正向评价
权重 - 1
预警阈值 - max(10%）
...
if __name__ == "__main__":
    ...
    gt_file = "../source_data/ZS232 - 服务效能指数.xlsx"

    df2 = convert_to_new_dataframe(source_file, gt_file, write_path='../tmp_zs232')
    ...
    # regression
    regression_test('../zs232_20190923.xlsx')
